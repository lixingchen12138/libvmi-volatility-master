...
#elif (1 || IN_LIBVIRT_GNULIB_TESTS || 1 || 1 \
       || 1 || IN_LIBVIRT_GNULIB_TESTS || 0 || IN_LIBVIRT_GNULIB_TESTS \
       || defined GNULIB_POSIXCHECK) \
      && ((defined _WIN32 || defined __WIN32__) && ! defined __CYGWIN__)
# include <io.h>
#endif
...
#if (IN_LIBVIRT_GNULIB_TESTS || IN_LIBVIRT_GNULIB_TESTS \
     || 1 || 0 \
